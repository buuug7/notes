...
(function($, window, document, undefined) {
  ...
  Plugin.prototype = {
    init: function() {
      ...
      defaults.fn = function() {
        ...
        if (xFlag == p.scrollX() && yFlag == p.scrollY()) {
          ...
          if (defaults.yOn) defaults.yPos = defaults.yPos + defaults.step;
          else defaults.yPos = defaults.yPos - defaults.step;
          ...
          if (defaults.xOn) defaults.xPos = defaults.xPos + defaults.step;
          else defaults.xPos = defaults.xPos - defaults.step;
    ...
    close: function(elem, defaults, isClose) {
      ...
      elem.hide();
      if (isClose) defaults.onClose.call(elem);
    },
        ...
        for (var i in options.ad) {
          ...
          $("<div>", {
            ...
            .append(
              $("<div>", {
                class: "button",
                style: ad["closed-icon"]
                  ? 'background:url("' + ad["closed-icon"] + '") no-repeat;'
                  : ""
              })
            )
            .appendTo(closeDiv);
          ...
          $("<a>", {
            ...
            .append(
              $("<img>", {
                src: ad.img,
                style:
                  (ad.imgHeight ? "height:" + ad.imgHeight + "px;" : "") +
